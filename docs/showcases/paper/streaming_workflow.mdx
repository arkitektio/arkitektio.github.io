...
1. Connect the nodes by dragging the output ports of one node to the input ports of another node. As illustrated in the [Live Analysis](/docs/introduction/advanced_tutorial/live), the
