...
You want to develop some functionality for the arkitekt framework. Great!
Without you this framework would not exist. So thank you for your contribution.
...
- **Easy to build and easy to use GUI and API**
  ...
  Arkitekt can build powerful and highly customizable widgets, that users can use when interfacing
...
- **Build safe tools**
  ...
  Arkitekt apps are always protected by a user and app authentication system. This means that
  you highly customize your application for specific users, restrict access to resources, and most importantly that
...
- Arkitekt is also **not** a tool for building highly parallelizable and highly available distributed systems. There are other frameworks
