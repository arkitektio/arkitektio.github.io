...
in the installation please make sure you have the latest version of Konstruktor installed. You can find the latest version [here](
    https://github.com/jhnnsrs/konstruktor/releases/latest/
).

### Crashing Konstruktor

This is definelty a bug from our side. Please post a screenshot of the crashed application and the error message as an Issue in our Konstruktor [GitHub](
    https://github.com/jhnnsrs/konstruktor/issues
). Sorry about that!
...
If all of these steps work, but Konstruktor still can't find docker, please open an Issue on our [GitHub](
    https://github.com/jhnnsrs/konstruktor/issues
). Sorry about that!
...
Konstruktor will try to download them from there. In the default configuration, Konstruktor will try to download the templates from the [konstruktor repository](
    https://github.com/jhnnsrs/konstruktor
). So make sure you have an internet connection, and that you can access GitHub. If you are behind a firewall, you might need to allow Konstruktor to access the Internet.
...
3. When checking your GPU, Konstruktor will check if Docker can run a container with the `nvidia/cuda` image. It will *NOT* check your CUDA installation
  ...
  Just check the LOGS section. If it looks like it detected your GPU correctly, you can safely ignore this warning. But please open an issue on our [GitHub](
    https://github.com/jhnnsrs/konstruktor/issues) and let us know about it.
...
That sounds like an error on our side. Please open an Issue on our [GitHub](
    https://github.com/jhnnsrs/konstruktor/issues
). Sorry about that! You can defintely help us by posting a screenshot of the error message. 
...
docker daemon to access the internet. If you are using a proxy, you might need to configure docker to use the proxy. You can find more information about this [here](
    https://docs.docker.com/network/proxy/
)

- If docker complains about not being able to find an image, please check if you have the latest version of Konstruktor installed. You can find the latest version [here](
    https://github.com/jhnnsrs/konstruktor
...
Attach the error message to an Issue on our [GitHub](
   https://github.com/jhnnsrs/konstruktor
...
Anyhow if you have a service that is not turning green, please open an Issue on our [GitHub](
    https://github.com/jhnnsrs/konstruktor
). We will try to help you!
...
If apps are not able to discover your Deployment, or you experience any other issue please open an Issue on our [GitHub](
    https://github.com/jhnnsrs/konstruktor
). We will try to help you!
