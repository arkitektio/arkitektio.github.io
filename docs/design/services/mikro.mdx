...
The Mikro [schema](/docs/design/graphql#schema) is the core of the system. It defines the data models and relationships
...
Or you can use the [API Explorer](/explorer) to interact with the system directly.
