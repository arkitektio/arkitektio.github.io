...
switches some of its core concepts around, which warrants a new service. This section describes the core concepts
of the system, and how it is designed to work.

:::note

While Kabinet will probably replace Port in the standard deployment, you will be still able to use Port if you
