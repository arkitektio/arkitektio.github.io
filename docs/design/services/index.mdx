...
import thumbnail from "./techstack.png";
...
- [Lok](lok.mdx): Authorization and Authentication service
- [Rekuest](rekuest.mdx): Node Repository and Task-Assignment
- [Port](port.mdx): Virtualizion of plugin apps
- [Mikro](mikro.mdx): Microscopy Data Management
- [Fluss](fluss.mdx): Workflow management
...
- [OmeroArk](omeroark.mdx): OMERO integration
- [Kluster](kluster.mdx): Dask-Cluster management
