...
Beginners setting up arkitekt should follow the [first steps guide](/docs/introduction/installation.mdx).
...
and is the default deployment strategy when using the [first steps guide](../introduction/installation.mdx).
