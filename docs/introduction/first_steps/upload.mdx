...
Lets try this out. Download the following file to your computer: [here](static/demos/cells1.TIF).
...
Before we move on, lets upload one more file. This time we will upload a 3D image. You can download it [here](static/demos/cells2.TIF).
