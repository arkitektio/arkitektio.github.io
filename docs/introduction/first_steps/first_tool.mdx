...
1. Click the `Dashboard` button in the left hand navigation.
  ...
  (you should see none display right now) and the status of the connected applications (you should now see the omero app in green). It will also show you the status of ongoing tasks 
...
4. You should now see a new `Reservation` on your dashboard.
...
design section of this documentation. In short they help Arkitekt keep track of the dependencies of your later workflows.. For now, just rest assured that you only have to reserve nodes *once*, Arkitekt will keep track of them until you say otherwise.
