...
We will start by converting our first file, utilizing our "Convert Omero" node. Lets perform this conversion on our
...
converted zarr dataset again to the server. More on that in [How Assignment Works](/docs/design/terminology/assignation). You will notice that
