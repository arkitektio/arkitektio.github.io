...
<small>When double clicking on the node in replay or live mode in a run, you can inspect the data flowing through the graph. Not to helpful here, but very much so
in the advanced workflows. </small>
</div>
