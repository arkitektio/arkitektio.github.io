...
find its explaination in the [Provision and Reservation](/docs/design/terminology/provision) section. Btw, in the next generation of rekuest, we will make this a lot more intuitive. That's
the hope at least.
