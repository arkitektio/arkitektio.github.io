...
Lets start by reserving our workflow. For this we will navigate to the "Workflows" tab. And then click on the "Reserve" button. This will reserve our workflow for us.
...
find its explaination in the [Provision and Reservation](/docs/design/provisions) section.
...
linked in your run and can be exported (e.g. in your methods section just like here)
...
While you click on your image, you will now see that there is derived images that are linked to your image. These are the images that are created by the workflow.
Just explore this datagraph.
