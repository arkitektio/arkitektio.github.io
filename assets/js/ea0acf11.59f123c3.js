...
`,d="my-2 p-2 rounded-md text-black text-center w-60 ",c=(0,i.Zh)((e=>{let{branch:t,repo:n,user:r}=e;const{client:c}=(0,i.AA)(),u=`${r}/${n}:${t}`,{data:m,refetch:h}=(0,a.a)(o,{client:c,variables:{tag:u},pollInterval:3e3});return(0,l.jsx)(l.Fragment,{children:m?.githubRepo?(0,l.jsxs)("button",{className:d+"bg-green-300",children:[" \u2705 ",u]}):(0,l.jsxs)("button",{onClick:async()=>{try{const{data:e}=await c.mutate({mutation:s,variables:{branch:t,repo:n,user:r}});await h(),console.log(e)}catch(e){console.log(e)}},className:d+"cursor-pointer bg-yellow-200",children:["\ud83e\ude84 Install ",u]})})}),(0,l.jsx)("div",{className:d+"bg-back-600",children:" \ud83c\udfb1 Connect to install"}))},88545:(e,t,n)=>{"use strict";n.d(t,{x:()=>o});var a=n(97120),i=n(31230),r=(n(67294),n(85893));const l=i.ZP`
