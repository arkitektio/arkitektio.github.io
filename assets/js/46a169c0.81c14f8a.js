...
`,c="my-2 p-2 rounded-md text-black text-center w-60 ",u=(0,a.Zh)((e=>{let{branch:n,repo:t,user:l}=e;const{client:u}=(0,a.AA)(),m=`${l}/${t}:${n}`,[p,h]=r.useState(!1),{data:g,refetch:f}=(0,i.a)(d,{client:u,variables:{tag:m},pollInterval:3e3});return(0,s.jsx)(s.Fragment,{children:g?.githubRepo?(0,s.jsxs)("button",{className:c+"bg-green-300",children:[" \u2705 ",m]}):(0,s.jsx)("button",{onClick:async()=>{try{h(!0);const{data:e}=await u.mutate({mutation:o,variables:{branch:n,repo:t,user:l}});await f(),console.log(e),h(!1)}catch(e){console.log(e)}},className:c+"cursor-pointer bg-yellow-200"+(p?" animate-pulse":""),children:p?(0,s.jsxs)(s.Fragment,{children:[" Installing ",m," "]}):(0,s.jsxs)(s.Fragment,{children:["\ud83e\ude84 Install ",m]})})})}),(0,s.jsx)("div",{className:c+"bg-back-600",children:" \ud83c\udfb1 Connect to install"}))},88545:(e,n,t)=>{"use strict";t.d(n,{x:()=>o});var i=t(97120),a=t(31230),l=(t(67294),t(85893));const r=a.ZP`
