...
`,c="my-2 p-2 rounded-md text-black text-center w-60 ",u=e=>{let{branch:t,repo:n,user:a}=e;const{client:r}=(0,i.AA)();return r?(0,s.jsx)(m,{branch:t,repo:n,user:a}):(0,s.jsxs)("div",{className:c+"bg-back-800 text-white bg-opacity-1 my-2",onDoubleClick:()=>alert("You need to be logged in to install repos."),children:[" ",a,"/",n,":",t]})},m=e=>{let{branch:t,repo:n,user:r}=e;const{client:u}=(0,i.AA)(),m=`${r}/${n}:${t}`,[p,h]=l.useState(!1),{data:g,refetch:f}=(0,a.a)(d,{client:u,variables:{tag:m},pollInterval:3e3});return(0,s.jsx)(s.Fragment,{children:g?.githubRepo?(0,s.jsxs)("button",{className:c+"bg-green-300",children:[" \u2705 ",m]}):(0,s.jsx)("button",{onClick:async()=>{try{h(!0);const{data:e}=await u.mutate({mutation:o,variables:{branch:t,repo:n,user:r}});await f(),console.log(e),h(!1)}catch(e){console.log(e)}},className:c+"cursor-pointer bg-yellow-200"+(p?" animate-pulse":""),children:p?(0,s.jsxs)(s.Fragment,{children:[" Installing ",m," "]}):(0,s.jsxs)(s.Fragment,{children:["\ud83e\ude84 Install ",m]})})})}},88545:(e,t,n)=>{"use strict";n.d(t,{x:()=>o});var a=n(97120),i=n(31230),r=(n(67294),n(85893));const l=i.ZP`
