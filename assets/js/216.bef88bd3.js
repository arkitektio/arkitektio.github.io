...
var src = __webpack_require__(98187);
...
function link_link(curve) {
  ...
  link.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : (0,src_constant/* default */.Z)(+_), link) : x;
  };

  link.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : (0,src_constant/* default */.Z)(+_), link) : y;
  };
