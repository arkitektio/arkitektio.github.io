...
`,B=e=>{let{flow:t,blockImport:a}=e;const{client:i}=(0,W.dB)(),[r,o]=function(e,t){var a=(0,O.x)(null==t?void 0:t.client);(0,F.Vp)(e,F.n_.Mutation);var i=n.useState({called:!1,loading:!1,client:a}),r=i[0],l=i[1],o=n.useRef({result:r,mutationId:0,isMounted:!0,client:a,mutation:e,options:t});Object.assign(o.current,{client:a,options:t,mutation:e});var s=n.useCallback((function(e){void 0===e&&(e={});var t=o.current,a=t.options,n=t.mutation,i=(0,I.pi)((0,I.pi)({},a),{mutation:n}),r=e.client||o.current.client;o.current.result.loading||i.ignoreResults||!o.current.isMounted||l(o.current.result={loading:!0,error:void 0,data:void 0,called:!0,client:r});var s=++o.current.mutationId,d=(0,R.J)(i,e);return r.mutate(d).then((function(t){var a,n,i=t.data,m=t.errors,c=m&&m.length>0?new U.cA({graphQLErrors:m}):void 0,u=e.onError||(null===(a=o.current.options)||void 0===a?void 0:a.onError);if(c&&u&&u(c,d),s===o.current.mutationId&&!d.ignoreResults){var p={called:!0,loading:!1,data:i,error:c,client:r};o.current.isMounted&&!(0,D.D)(o.current.result,p)&&l(o.current.result=p)}var g=e.onCompleted||(null===(n=o.current.options)||void 0===n?void 0:n.onCompleted);return c||null==g||g(t.data,d),t})).catch((function(t){var a;if(s===o.current.mutationId&&o.current.isMounted){var n={loading:!1,error:t,data:void 0,called:!0,client:r};(0,D.D)(o.current.result,n)||l(o.current.result=n)}var i=e.onError||(null===(a=o.current.options)||void 0===a?void 0:a.onError);if(i)return i(t,d),{data:void 0,errors:t};throw t}))}),[]),d=n.useCallback((function(){o.current.isMounted&&l({called:!1,loading:!1,client:a})}),[]);return n.useEffect((function(){return o.current.isMounted=!0,function(){o.current.isMounted=!1}}),[]),[s,(0,I.pi)({reset:d},r)]}(q,{client:i}),s=async()=>{try{const a=(e=m(t.graph.nodes),e?.map((e=>{if(e){const{id:t,position:a,type:n,parentNode:i,data:{outstream:r,constream:o,instream:s,...m}}=e;return{outstream:r?.map((e=>e?e.filter(l).map(d):[]))||[[]],constream:o?.map((e=>e?e.filter(l).map(d):[]))||[[]],instream:s?.map((e=>e?e.filter(l).map(d):[]))||[[]],id:t,position:{x:a.x,y:a.y},typename:n||"Fake type",name:m.name,description:m.description,hash:m.hash,implementation:m.implementation,kind:m.kind,defaults:m.defaults,mapStrategy:m.mapStrategy,allowLocal:m.allowLocal,maxRetries:m.maxRetries,retryDelay:m.retryDelay,binds:m.binds,parentNode:i,interface:m.interface}}})).filter(l)||[]||[]),n=(e=>e?.map((e=>{if(console.log(e),e){const{id:t,source:a,sourceHandle:n,target:i,targetHandle:r,type:o,data:s}=e;return{id:t,typename:o||"Fake type",source:a,sourceHandle:n||"returns",target:i,targetHandle:r||"args",stream:s?.stream.filter(l).map(d)||[]}}})).filter(l)||[])(c(t.graph.edges));let i={nodes:a,edges:n,globals:t.graph.globals.filter(l).map(d),args:t.graph.args.filter(l).map(d),returns:t.graph.returns.filter(l).map(d)};await r({variables:{name:t.name,graph:i}})}catch(a){alert(a.message)}var e};return n.createElement("button",{onClick:()=>s(),disabled:a,className:"bg-primary-300 hover:bg-primary-400 py-2 px-3 rounded rounded-md disabled:bg-back-800"},"Re-Import into Arkitekt")},G=e=>n.createElement("div",{className:"border border-1 rounded border-gray-800"},n.createElement("div",{className:"flex w-full h-[400px] flex-col  overflow-hidden relative"},n.createElement(T,{flow:e.flow})),n.createElement(C,{className:"flex w-full p-3 border-t-2 border-gray-800",hideLabel:"Connect to use this workflow"},n.createElement(W.Ot,null,n.createElement(B,{flow:e.flow,blockImport:e.blockImport}))))},33346:(e,t,a)=>{"use strict";a.d(t,{L:()=>i});var n=a(67294);const i=e=>n.createElement(n.Fragment,null,"CONNECTED")},20263:(e,t,a)=>{"use strict";a.d(t,{J5d:()=>i,XTL:()=>r});var n=a(31230);let i=function(e){return e.Add="ADD",e.All="ALL",e.And="AND",e.BufferComplete="BUFFER_COMPLETE",e.BufferUntil="BUFFER_UNTIL",e.Chunk="CHUNK",e.Combinelatest="COMBINELATEST",e.Delay="DELAY",e.DelayUntil="DELAY_UNTIL",e.Divide="DIVIDE",e.Ensure="ENSURE",e.Filter="FILTER",e.Foreach="FOREACH",e.Gate="GATE",e.If="IF",e.Modulo="MODULO",e.Multiply="MULTIPLY",e.Omit="OMIT",e.Power="POWER",e.Prefix="PREFIX",e.Split="SPLIT",e.Subtract="SUBTRACT",e.Suffix="SUFFIX",e.ToList="TO_LIST",e.Withlatest="WITHLATEST",e.Zip="ZIP",e}({}),r=function(e){return e.Bool="BOOL",e.Dict="DICT",e.Enum="ENUM",e.Float="FLOAT",e.Int="INT",e.List="LIST",e.String="STRING",e.Structure="STRUCTURE",e.Union="UNION",e.Unset="UNSET",e}({});const l=n.Ps`
