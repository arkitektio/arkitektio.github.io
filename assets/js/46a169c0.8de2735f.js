...
`,G=e=>{let{flow:t,blockImport:n}=e;const{client:i}=(0,C.dB)(),[l,o]=function(e,t){var n=(0,B.x)(null==t?void 0:t.client);(0,O.Vp)(e,O.n_.Mutation);var i=a.useState({called:!1,loading:!1,client:n}),l=i[0],r=i[1],o=a.useRef({result:l,mutationId:0,isMounted:!0,client:n,mutation:e,options:t});Object.assign(o.current,{client:n,options:t,mutation:e});var s=a.useCallback((function(e){void 0===e&&(e={});var t=o.current,n=t.options,a=t.mutation,i=(0,I.pi)((0,I.pi)({},n),{mutation:a}),l=e.client||o.current.client;o.current.result.loading||i.ignoreResults||!o.current.isMounted||r(o.current.result={loading:!0,error:void 0,data:void 0,called:!0,client:l});var s=++o.current.mutationId,d=(0,x.J)(i,e);return l.mutate(d).then((function(t){var n,a,i=t.data,u=t.errors,c=u&&u.length>0?new F.cA({graphQLErrors:u}):void 0,m=e.onError||(null===(n=o.current.options)||void 0===n?void 0:n.onError);if(c&&m&&m(c,d),s===o.current.mutationId&&!d.ignoreResults){var p={called:!0,loading:!1,data:i,error:c,client:l};o.current.isMounted&&!(0,D.D)(o.current.result,p)&&r(o.current.result=p)}var g=e.onCompleted||(null===(a=o.current.options)||void 0===a?void 0:a.onCompleted);return c||null==g||g(t.data,d),t})).catch((function(t){var n;if(s===o.current.mutationId&&o.current.isMounted){var a={loading:!1,error:t,data:void 0,called:!0,client:l};(0,D.D)(o.current.result,a)||r(o.current.result=a)}var i=e.onError||(null===(n=o.current.options)||void 0===n?void 0:n.onError);if(i)return i(t,d),{data:void 0,errors:t};throw t}))}),[]),d=a.useCallback((function(){o.current.isMounted&&r({called:!1,loading:!1,client:n})}),[]);return a.useEffect((function(){return o.current.isMounted=!0,function(){o.current.isMounted=!1}}),[]),[s,(0,I.pi)({reset:d},l)]}(U,{client:i}),s=async()=>{try{const n=(e=u(t.graph.nodes),e?.map((e=>{if(e){const{id:t,position:n,type:a,parentNode:i,data:{outstream:l,constream:o,instream:s,...u}}=e;return{outstream:l?.map((e=>e?e.filter(r).map(d):[]))||[[]],constream:o?.map((e=>e?e.filter(r).map(d):[]))||[[]],instream:s?.map((e=>e?e.filter(r).map(d):[]))||[[]],id:t,position:{x:n.x,y:n.y},typename:a||"Fake type",name:u.name,description:u.description,hash:u.hash,implementation:u.implementation,kind:u.kind,defaults:u.defaults,mapStrategy:u.mapStrategy,allowLocal:u.allowLocal,maxRetries:u.maxRetries,retryDelay:u.retryDelay,binds:u.binds,parentNode:i,interface:u.interface}}})).filter(r)||[]||[]),a=(e=>e?.map((e=>{if(console.log(e),e){const{id:t,source:n,sourceHandle:a,target:i,targetHandle:l,type:o,data:s}=e;return{id:t,typename:o||"Fake type",source:n,sourceHandle:a||"returns",target:i,targetHandle:l||"args",stream:s?.stream.filter(r).map(d)||[]}}})).filter(r)||[])(c(t.graph.edges));let i={nodes:n,edges:a,globals:t.graph.globals.filter(r).map(d),args:t.graph.args.filter(r).map(d),returns:t.graph.returns.filter(r).map(d)};await l({variables:{name:t.name,graph:i}})}catch(n){alert(n.message)}var e};return a.createElement("button",{onClick:()=>s(),disabled:n,className:"bg-primary-300 hover:bg-primary-400 py-2 px-3 rounded rounded-md disabled:bg-back-800"},"Re-Import into Arkitekt")},q=e=>a.createElement("div",{className:"border border-1 rounded border-gray-800"},a.createElement("div",{className:"flex w-full h-[400px] flex-col  overflow-hidden relative"},a.createElement(N,{flow:e.flow})),a.createElement(R,{className:"flex w-full p-3 border-t-2 border-gray-800",hideLabel:"Connect to use this workflow"},a.createElement(C.Ot,null,a.createElement(G,{flow:e.flow,blockImport:e.blockImport}))))},33346:(e,t,n)=>{"use strict";n.d(t,{L:()=>i});var a=n(67294);const i=e=>a.createElement(a.Fragment,null,"CONNECTED")},20263:(e,t,n)=>{"use strict";n.d(t,{J5d:()=>i,XTL:()=>l});var a=n(31230);let i=function(e){return e.Add="ADD",e.All="ALL",e.And="AND",e.BufferComplete="BUFFER_COMPLETE",e.BufferUntil="BUFFER_UNTIL",e.Chunk="CHUNK",e.Combinelatest="COMBINELATEST",e.Delay="DELAY",e.DelayUntil="DELAY_UNTIL",e.Divide="DIVIDE",e.Ensure="ENSURE",e.Filter="FILTER",e.Foreach="FOREACH",e.Gate="GATE",e.If="IF",e.Modulo="MODULO",e.Multiply="MULTIPLY",e.Omit="OMIT",e.Power="POWER",e.Prefix="PREFIX",e.Split="SPLIT",e.Subtract="SUBTRACT",e.Suffix="SUFFIX",e.ToList="TO_LIST",e.Withlatest="WITHLATEST",e.Zip="ZIP",e}({}),l=function(e){return e.Bool="BOOL",e.Dict="DICT",e.Enum="ENUM",e.Float="FLOAT",e.Int="INT",e.List="LIST",e.String="STRING",e.Structure="STRUCTURE",e.Union="UNION",e.Unset="UNSET",e}({});const r=a.Ps`
