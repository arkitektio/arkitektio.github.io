...
description: An interactive Arkitekt workflow spanning Napari, Care denoising and Fiji to interactively denoise and segment cells in 3D images.
group: paper
tags: ["Napari", "Fiji", "Denoising", "Segmentation"]
version: paper
---
...
import { LatestImage } from "@/components/arkitekt";
...
![The interactive workflow with loopback analytical insight](/docs/showcases/paper/interactive.png)
...
you can easily import it into your arkitekt instance. To do so, please [connect](/docs/introduction/first-steps/brief-interlude#we-have-an-app-for-that) this website to your arkitekt instance and then simply click on the "import" button below,
which will import it directly into your arkitekt instance.

If you havent installed any of the apps yet, your Arkitekt instance will tell you that you are missing some apps implementing the actions. So of course make sure you
...
#### [Kare Denoising](https://github.com/arkitektio-apps/kare)
...
#### [ImageJ Arkitekt Plugin](https://github.com/arkitektio/imagej-arkitekt-plugin)

The Fiji plugin that connects your Fiji instance to Arkitekt. Please install the latest release into your Fiji `plugins/` folder,
see the [plugin page](/docs/apps/standalones/imagej-plugin) for details.
...
The Image Data was converted through the `Convert Omero` Action provided by
...
[Deep Learning Training Tutorial](/docs/introduction/advanced/training) to train your own model. If you want to use a pretrained model, you can upload the pretrained model directly from the link below.

<UploadModelButton name="Tribolium Model" kind="TENSORFLOW" />
...
- Fiji (with the ImageJ Arkitekt plugin)
