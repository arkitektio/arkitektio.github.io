---
title: Apps
description: A collection of Standalone Apps and Plugin Apps that hook into the Arkitekt platform and provide its actual functionality.
---

#### Standalones

[Standalones](/docs/apps/standalones) are Apps that are installable anywhere in your lab on any computer, and are designed to be user-friendly entrypoints
...
[Plugins](/docs/apps/plugins) are also Apps but are built using software containers, so come with their own set of requirements and limitations.
