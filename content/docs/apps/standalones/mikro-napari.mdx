---
title: Mikro-Napari
description: A plugin that enables your local Napari installation to communicate with Arkitekt for interactive image visualization.
---
...
Walk through this in [Your first app](/docs/introduction/first-steps/first-app), where we open a converted image in Napari.
...
<video
  ...
  width={"100%"}
>
  <source src="/docs/apps/standalones/open_napari.webm" />
</video>
...
1. **The Magic Bar**:
   ...
   you will encounter it in almost all apps that currently can connect to Arkitekt.
...
3. **Login in the Browser**:
   A browser opens and you approve the device login, exactly as you did for Orkestrator, see [Almost there](/docs/introduction/first-steps/interface#almost-there).
...
models to segment your images, and then visualize the results in Napari, shown [here](/docs/introduction/advanced/deep-learning))
...
<video
  ...
  width={"100%"}
>
  <source src="/docs/apps/standalones/napari_visualize.webm" />
</video>
