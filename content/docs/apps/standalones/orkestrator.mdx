---
title: Orkestrator
description: The primary user interface for the Arkitekt platform, available as a desktop and web application for creating and managing workflows.
---
...
- **Automatic Network Configuration**: The desktop application is able to automatically find Arkitekt instances you have connected through the
  [mesh](/docs/design/security/mesh) and connect to them. This means that you don't have to manually enter the address of the Arkitekt instance you want to connect
...
<Callout type="info" title="Why these limitations?">
