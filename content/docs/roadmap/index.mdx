---
title: Next
description: An overview of the upcoming next version of the Arkitekt platform, focusing on improved user experience, data management, and stability.
---

<Callout type="info" title="From here be dragons">
...
Arkitekt lets you assign tasks to actions directly. Just point your data at an action and
an available agent runs it immediately. This makes starting a task far more intuitive and removed a whole class of confusing
edge cases along the way.
...
<Callout type="info" title="Breaking changes">
