...
<Callout type="warn" title="On Mac compability">
...
<video
  ...
  width={"100%"}
>
  <source src="/docs/introduction/first_steps/connect_imagej.webm" />
</video>
...
1. _Cross Talk_:
   When calling the `Show on Imagej` action, MikroJ will download the whole image into memory and share this image with Fiji. This means that you can
...
2. _ROIs_:
   ...
   yet found a good solution. If you have any ideas, please reach out. You can however extract the ROIS on an Image in Fiji through an `Action`.
