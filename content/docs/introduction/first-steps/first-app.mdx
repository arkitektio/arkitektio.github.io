...
the ROIs that you have created in Orkestrator.
...
2. _ROIs_:
   If you have created ROIs in Orkestrator, you can also visualize them in Napari. Just make sure that you have the "Show ROI Layer" option enabled, when
   assigning the action. Importantly you will notice that if you mark rois on the ROI layer they are _live syncing_ with your server and Orkestrator, and
...
1. _Cross Talk_:
   ...
   close Orkestrator and the image will still be available in Fiji.

2. _ROIs_:
   ROIs are synced between Fiji's ROI manager and the Arkitekt instance, so regions you draw in Fiji become available in Orkestrator and in other apps.
