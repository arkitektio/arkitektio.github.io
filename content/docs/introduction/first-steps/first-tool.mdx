...
through the Arkitekt interface, and can run completely virtualized separate from your operating system (more about that in ["Arkitekt and Containers"](/docs/design/various/containers),
and on how plugins compare to standalone apps in [Apps](/docs/apps)).
...
Arkitekt ecosystem (more on that below).
