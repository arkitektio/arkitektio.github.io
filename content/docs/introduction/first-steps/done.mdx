---
title: Done
description: Congratulations on completing the beginner tutorial, with pointers to advanced tutorials, showcases, and how to give feedback.
---
...
Especially the [advanced tutorial](/docs/introduction/advanced) will show you some more advanced features, like enabling
a loopback of deep learning predictions to the input data, or how to use the software in a more automated fashion.

Also make sure to check out the [Showcases](/showcase) section, where we will add more and more examples of how the software is used in the wild.
This might give you some ideas of how to use it in your own research.

## Feedback

Probably you have noticed that the software is not perfect. There are some bugs, some things that are not intuitive, and some things that are missing.
