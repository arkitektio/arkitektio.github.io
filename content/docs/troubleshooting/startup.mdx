...
3. Make sure you can reach your deployment, either on the same machine, or across networks through the [mesh](/docs/design/security/mesh). (Local-network advertising has been removed, see the [installation guide](/docs/introduction/installation#advertising).)
...
4. For automatic detection: Make sure that:
   ...
   - Your deployment and the Desktop App have both [joined the mesh](/docs/introduction/installation#joining-the-mesh), so they can discover each other.
