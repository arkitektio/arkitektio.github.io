---
title: Help!
description: General troubleshooting guidance for Arkitekt, including how to effectively restart and update parts of the system.
---
...
If you encounter any problems that you feel shouln't be problems , please head to https://forum.image.sc/, where our community is happy to help you.
We will try to answer your questions as soon as possible. This should also be the first place to go, if you have any questions about the platform or the apps.
...
1. [General Troubleshooting](/docs/troubleshooting/general) (this page)
2. [Troubleshooting the Installation and the Server](/docs/troubleshooting/startup)
3. [Troubleshooting the Orkestrator Interface](/docs/troubleshooting/interface)
4. [Troubleshooting connected Apps](/docs/troubleshooting/app)

But first, allow us some general words about effective troubleshooting, with Arkitekt.

## Reload!, Restart!, Restart!

<img src="/docs/troubleshooting/turn.jpeg" alt="Reload and restart" />
...
<Callout type="info" title="But what about my Data">
...
You can find information about how to update the platform and the apps in the [installation section](/docs/introduction/installation/starting-new#updating).
...
you should have a look at the [Orkestrator](https://github.com/arkitektio/orkestrator/releases).

<Callout type="info" title="But I am already on the latest version">
