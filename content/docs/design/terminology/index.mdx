...
A **Workflow** is a graph of nodes wired together, where the output of one node becomes the input of the next, and each node runs an [Action](/docs/design/terminology/action). See [Workflow](/docs/design/terminology/workflow).
