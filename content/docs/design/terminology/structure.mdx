...
description: Structures are a core building block in Arkitekt that let you use complex data types in your workflows and apps via shrinking and expanding.
---
