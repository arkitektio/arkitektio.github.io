---
title: Development
description: Spinning up a development Arkitekt Server from within your Python code to test your App against a real server.
---
...
versions; how the channels relate is described in [How we version Arkitekt](/docs/design/philosophy/version).
...
![A local development deployment](/docs/design/deployment/on_premise/local.png)

<div className="text-gray-400 mb-2 mt-4">
<small> A local development deployment: the `deployment` function brings up a throwaway Arkitekt Server on your machine, next to the
App you are developing, so the App can connect to it and be tested against real services. </small>
</div>
</div>
