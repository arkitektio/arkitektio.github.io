---
title: GraphQL
description: Why Arkitekt exposes all of its functionality through GraphQL APIs and how that benefits bioimage analysis.
---
...
REST is widely used and well understood, but it has limitations for highly relational bioimage data.
Read [Why Not REST](/docs/design/comparisons/rest) for the trade-offs.
...
![The GraphQL request, resolve, response](/docs/design/various/graphql.png)

<figcaption className="mt-2 text-sm text-fd-muted-foreground">The GraphQL request, resolve, response</figcaption>
</figure>
