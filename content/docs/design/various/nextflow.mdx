---
title: Nextflow
description: Exploring strategies for integrating Arkitekt Apps with Nextflow workflows.
---
...
the process definition directly from an Action definition. This should be pretty straightforward to do. 
