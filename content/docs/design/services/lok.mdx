---
title: Lok
description: A central, distributed backend for managing and authorizing users and applications using OAuth2, OpenID Connect, and JWT tokens.
---
...
Lok employs patterns for distributed authentication and authorization, through the use of JWT tokens: cryptographically
signed claims that any service can verify on its own, as described in [Identity & Access](/docs/design/security/identity).

<div className="mt-2 p-6 w-full">

![Lok](/docs/design/services/lok.png)
