...
description: How to use the turms library and the Arkitekt CLI to generate typed Python code for interacting with the GraphQL API.
---

<Callout type="info">


This guide is an emerging documentation for now check out [turms](https://github.com/jhnnsrs/turms) for more information.
...
To get started, you will need an Arkitekt project created with `arkitekt-next init`, as shown in [Your first plugin](/docs/developers/python/plugin).
Inside that project directory, we can now generate a configuration file for our code generation for our project by running the following command:
...
<Callout type="info" title="Why the nested `mikro` folder?">
