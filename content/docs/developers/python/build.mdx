...
description: How to package, build, stage, and publish an Arkitekt plugin from your Python code using flavours and Docker.
---
...
<Callout type="info" title="On Flavours">
...
<Callout type="info" title="On Paths">
...
<Callout type="warn" title="On Versioning">
...
Why we insist on this is explained in [Why we version](/docs/design/philosophy/version).

</Callout>

<Callout type="info" title="On Registries">
