    ...
    >
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
        ...
        <span className="text-amber-100/80">
          This site is being rebuilt for the next release of Arkitekt. Pages may
          be incomplete or change without notice. Please check back soon!
        </span>
      </div>
    </div>
  );
  ...
  return (
    <main className="flex flex-1 flex-col px-6 pb-24 pt-6 sm:px-6 lg:px-8">
      ...
      <footer className="mt-16 flex flex-col items-center gap-1 text-center text-sm text-fd-muted-foreground">
        ...
        <p className="text-xs">
          We don&apos;t want your data. Here&apos;s exactly what we do and
          don&apos;t touch.
        </p>
      </footer>
    </main>
